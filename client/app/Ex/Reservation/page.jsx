        ...
        <div className="full-reserve bg-center  bg-contain">
            ...
            <div className=" px-6 sm:px-16 max-w-7xl mx-auto bg-black/50 ">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 items-start ">
                    ...
                    <motion.form
                        className="rounded-lg shadow-md p-6 flex flex-col text-white"
                    ...
                    >
                        ...
                        <span className="flex justify-between items-center text-xl font-bold mb-4  text-gray-500 font-mono">
